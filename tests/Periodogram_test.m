...
aoa = isac.estimation.Periodogram.estimateAoA(data.Y, array, 1024);

range = isac.estimation.Periodogram.estimateRange(data.Y, data.Symbols, waveform, 1024);

doppler = isac.estimation.Periodogram.estimateDoppler(data.Y, data.Symbols, waveform, 1024);
